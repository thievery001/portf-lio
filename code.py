...
print("As operações aritméticas elas são a base de qualquer linguagem de programção, inluindo python, elas permite que nós possamos fazer cálculos simples e complexos que é utilizado em toda criação de programa em python")
...
#A Soma, ela adiciona valores. É representada pelo símebolo (+)
print('''soma = a + b
         print("Soma (a+b):", soma)''')

#A Sutração, ela subtrai o segundo valor do primeiro. É representada pelo símbolo (-)
print('''subtracao = a - b
         print("Subtração (a-b):", subtracao)''')

#A Multiplicação, ela multiplica todos os valores. É representada pelo símbolo (*)
print('''multiplicacao = a * b
         print("Multiplicação (a*b):", multiplicacao)''')

#A Divisão, ela retorna um número float. É representada pelo símbolo (/)
print('''divisao = a / b
         print("Divisão (a/b):", divisao)''')

#A Divisão inteira, ela descarta o valor decimal(float) e apenas imprime o valor inteiro. É representada pelos símbolos (//)
...
print("O python ele respeita uma ordem de prioridade entre os operadores. Parênteses > Exponenciação > Multiplicação|Divisão > Soma|Subtração")
